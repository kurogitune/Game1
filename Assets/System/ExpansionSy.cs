...
namespace Exception//自作拡張?
{
    ...
    public class PlayerObjOUT//プレイヤーのタグが付いたオブジェクトを取得
    {
        public static GameObject PlayerObjGet()
        {
    ...
    public class Option_Data//設定データ
    {
        ...
        public float PlayerRoteSped = 5;//プレイヤーの回転速度
    }
