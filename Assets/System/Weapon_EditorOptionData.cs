...
public class Weapon_EditorOptionData : ScriptableObject//武器エディタオプションデータ
{
    ...
    public Color Carrier_based_fighter_Color;//艦上戦闘機
    public Color Water_fighter_Color;//水上戦闘機
    public Color Shipboard_bomber_Color;//艦上爆撃機
    public Color Water_bomber_Color;//水上爆撃機
    public Color Carrier_based_attack_aircraft_Color;//艦上攻撃機
    public Color Ship_reconnaissance_aircraft_Color;//艦上偵察機
    public Color Water_reconnaissance_aircraft_Color;//水上偵察機
    public Color Anti_submarine_patrol_aircraft_Color;//対潜哨戒機
    public Color Electric_search_Color;//電探
    ...
    public Color Sonar_Color;//ソナー
    public Color Repai_personnel_Color;//修理要員
    public Color Expansion_basil_Color;//増設バジル
    public Color No_classification_Color;//分類無
    public Color Land_attack_aircraft_Color;//陸上攻撃機
    public Color Land_reconnaissance_aircraft_Color;//陸上偵察機
    public Color Local_fighter_Color;//局地戦闘機
    public Color Army_fighter_Color;//陸軍戦闘機
}
